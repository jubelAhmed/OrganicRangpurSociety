...
<div class="crm_clear"></div> 
  ...
  <?php esc_html_e('Disable Automatic Export', 'gravity-forms-googlesheets-crm'); ?>
  ...
  <?php _e('Disable Automatic Export', 'gravity-forms-googlesheets-crm'); ?>
  </span></legend>
  <label for="crm_manual_export">
  ...
  <?php _e( 'Manually send the entries to Google Sheets.', 'gravity-forms-googlesheets-crm'); ?> </label>
  </fieldset>
  </div>
